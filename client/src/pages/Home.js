        ...
        <div className='intro'>
            <div className='section-1'>
              <div className='section-1-text'>
                ...
                <p>I am a software developer using the MERN stack. Aside from coding, I enjoy bartending, and training in MMA.</p>         
          ...
          <div className='section-2'>
            <div className='section-2-text'>
              <h2>Current Focus</h2>
              <p>Neat on the Rocks is a site I have been meaning to code for years now. It all started in college when I started taking nutrition very serious. I always found it difficult to get information on the beverages I was drinking at parties. I knew there had to be a better way. Using my passion for chemistry and nutrition, I was able to build a prototype in excel, but since the day I made it, I have been meaning to share it with the world.</p>
            </div>
